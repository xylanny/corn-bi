    ...
    >
      ...
      <div class="sidebar-footer">
        <button class="footer-toggle" @click="toggleOpen">
          <svg width="32" height="32" viewBox="0 0 20 20" fill="var(--ft-clr)">
            <path
              d="M15 5L10 10L15 15"
              stroke="currentColor"
              stroke-width="2"
